    ...
    choices: [
      {
        ...
        recommended: decision.recommendation === "approve_refund",
        reversible: false,
      },
      {
        ...
        recommended: decision.recommendation === "offer_store_credit",
        reversible: true,
      },
      {
        id: "deny_refund",
        ...
        recommended: decision.recommendation === "deny_refund",
        reversible: true,
      },
    ],
